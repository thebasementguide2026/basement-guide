...
const sections = [
  ...
  },
  {
    ...
    slugs: ['basement-vs-crawl-space-vs-slab', 'battery-vs-water-powered-sump-pumps', 'drylok-vs-radonseal', 'french-drain-vs-sump-pump', 'submersible-vs-pedestal-sump-pump', 'interior-vs-exterior-waterproofing'],
    featured: [],
  },
]
