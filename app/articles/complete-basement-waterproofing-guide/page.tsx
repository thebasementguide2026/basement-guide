    ...
    <main className="bg-white text-gray-800">
      ...
      <article className="max-w-4xl mx-auto px-4 py-12 md:py-16">
        ...
        <div className="prose prose-lg max-w-none mb-12">
          ...
          <p className="mt-6">This guide cuts through the noise. Whether you are dealing with a minor dampness problem you want to fix yourself or a full-blown flooding situation that needs professional help, you will find honest, detailed answers here.</p>
        </div>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-700 mb-4">Damp-proofing is a thin asphalt-based coating applied to the exterior of foundation walls during construction. It resists moisture vapor but cannot handle hydrostatic pressure or actual water flow. Waterproofing uses thicker membranes, drainage systems, and multiple layers of protection to create a genuinely water-tight barrier. Many older homes only have damp-proofing, which is why they develop water problems as the coating degrades and soil conditions change over decades.</p>

          <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Will a dehumidifier fix my wet basement?</h3>
          <p className="text-gray-700 mb-4">A dehumidifier can help manage humidity and condensation, but it cannot fix actual water intrusion. If water is entering through cracks, the cove joint, or through porous concrete, a dehumidifier is treating the symptom, not the cause. Think of a dehumidifier as an essential companion to waterproofing, not a replacement for it. See our <Link href="/articles/dehumidifier-myths" className="text-teal-700 underline hover:text-teal-900">dehumidifier myths guide</Link> for common sizing mistakes and our <Link href="/articles/best-basement-dehumidifiers" className="text-teal-700 underline hover:text-teal-900">best basement dehumidifiers guide</Link> for product recommendations.</p>

          <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">How do I know if I need a French drain?</h3>
          <p className="text-gray-700 mb-4">If you experience recurring water on your basement floor, especially during or after rain, a French drain is likely part of the solution. Specific signs include water appearing along the base of walls (at the cove joint), water coming up through floor cracks, and chronic dampness that persists despite applying sealants and running a dehumidifier. If only one or two walls show water entry, you may be able to install a partial perimeter system. See our <Link href="/articles/french-drain-vs-sump-pump" className="text-teal-700 underline hover:text-teal-900">french drain vs sump pump comparison</Link> for help deciding which approach fits your situation.</p>

          <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Can I finish my basement before waterproofing?</h3>
          <p className="text-gray-700 mb-4">Do not finish a basement that has any moisture issues. Drywall, carpet, and wood framing will trap moisture, promote mold growth, and deteriorate rapidly. Waterproof first, verify the system is working through at least one full rainy season, and then finish. See our <Link href="/articles/pre-finish-audit" className="text-teal-700 underline hover:text-teal-900">pre-finish audit checklist</Link> for what to verify before starting any finishing work and our <Link href="/articles/basement-finishing-cost" className="text-teal-700 underline hover:text-teal-900">basement finishing cost guide</Link> for budgeting.</p>
          ...
          <p className="text-gray-700 mb-4">Almost always, yes. The average cost of interior waterproofing ($3,000 to $8,000) is a fraction of what you would pay for mold remediation ($1,500 to $9,000), foundation structural repair ($5,000 to $50,000), or the reduced selling price of a home with water damage history (10 to 20 percent below market). A dry, waterproofed basement also makes your home easier to sell and can increase appraised value. See our <Link href="/articles/waterproofing-home-appraisal-value" className="text-teal-700 underline hover:text-teal-900">waterproofing and home appraisal value guide</Link> for specific data.</p>

          <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Does basement waterproofing affect radon levels?</h3>
          <p className="text-gray-700 mb-4">Yes. Many of the same foundation openings that allow water into your basement (cracks, the cove joint, gaps around pipes, porous concrete) also allow radon gas to enter. Sealing these openings as part of waterproofing can reduce radon levels by up to 50 percent. However, waterproofing alone is not a substitute for a dedicated radon mitigation system if your levels are above the EPA action level of 4 pCi/L. See our <Link href="/articles/radon-and-basement-waterproofing" className="text-teal-700 underline hover:text-teal-900">radon and basement waterproofing guide</Link> for how the two systems interact and our <Link href="/articles/basement-radon-testing-mitigation-guide" className="text-teal-700 underline hover:text-teal-900">radon testing and mitigation guide</Link> for testing instructions.</p>
        </section>

        {/* Glossary */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Glossary of Basement Waterproofing Terms</h2>
          <dl className="space-y-4 text-gray-700">
            <div><dt className="font-bold">Hydrostatic pressure.</dt><dd>The lateral force exerted by water-saturated soil against a foundation wall or floor. Hydrostatic pressure is the primary cause of basement water intrusion, wall bowing, and floor heaving. Managing hydrostatic pressure through drainage is more effective than trying to block it with sealants.</dd></div>
            <div><dt className="font-bold">Cove joint.</dt><dd>The seam where the basement floor slab meets the foundation wall. Because the floor and walls are poured at different times, they are not structurally bonded, leaving a natural gap. This gap is the single most common entry point for water in basements.</dd></div>
            <div><dt className="font-bold">French drain (drain tile).</dt><dd>A drainage system consisting of a perforated pipe laid in a gravel-filled trench, designed to collect and redirect groundwater. See our <Link href="/articles/french-drain-cost" className="text-teal-700 underline hover:text-teal-900">french drain cost guide</Link> for pricing.</dd></div>
            <div><dt className="font-bold">Sump pump.</dt><dd>An electrically powered pump installed in a pit (sump basin) at the lowest point of the basement floor. See our <Link href="/articles/sump-pump-buying-guide" className="text-teal-700 underline hover:text-teal-900">sump pump buying guide</Link> for selection advice.</dd></div>
            <div><dt className="font-bold">Efflorescence.</dt><dd>A white, powdery mineral deposit that appears on concrete, brick, or block surfaces when water migrates through the material and evaporates, leaving dissolved salts behind. See our <Link href="/articles/basement-efflorescence" className="text-teal-700 underline hover:text-teal-900">efflorescence guide</Link>.</dd></div>
            <div><dt className="font-bold">Vapor barrier.</dt><dd>A sheet of polyethylene plastic or similar impermeable material installed on basement walls to prevent water vapor from passing through concrete into the finished living space. See our <Link href="/articles/best-vapor-barriers" className="text-teal-700 underline hover:text-teal-900">best vapor barriers guide</Link>.</dd></div>
            <div><dt className="font-bold">Stack effect.</dt><dd>The natural tendency of warm air to rise through a building, creating lower pressure at the basement level that pulls air upward from the basement into the living spaces above.</dd></div>
            <div><dt className="font-bold">Damp-proofing.</dt><dd>A thin asphalt-based coating applied to the exterior of foundation walls during construction to resist moisture vapor. Damp-proofing is not waterproofing.</dd></div>
            <div><dt className="font-bold">Crystalline waterproofing.</dt><dd>A chemical treatment applied to concrete surfaces that reacts with moisture and calcium hydroxide in the concrete to form insoluble crystals within pores, capillary tracts, and hairline cracks. See our <Link href="/articles/crystalline-waterproofing" className="text-teal-700 underline hover:text-teal-900">crystalline waterproofing guide</Link>.</dd></div>
            <div><dt className="font-bold">Waterproofing membrane.</dt><dd>A thick, flexible sheet or liquid-applied coating applied to the exterior surface of foundation walls below grade to create a continuous waterproof barrier.</dd></div>
          </dl>
        </section>

        {/* Related Guides */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Related Guides on The Basement Guide</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link href="/articles/basement-waterproofing-cost" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Basement Waterproofing Cost</h4></Link>
            <Link href="/articles/interior-vs-exterior-waterproofing" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Interior vs Exterior Waterproofing</h4></Link>
            <Link href="/articles/interior-basement-drainage-systems" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Interior Basement Drainage Systems</h4></Link>
            <Link href="/articles/french-drain-cost" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">French Drain Cost</h4></Link>
            <Link href="/articles/french-drain-vs-sump-pump" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">French Drain vs Sump Pump</h4></Link>
            <Link href="/articles/sump-pump-buying-guide" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Sump Pump Buying Guide</h4></Link>
            <Link href="/articles/sump-pump-cost" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Sump Pump Cost</h4></Link>
            <Link href="/articles/best-sump-pumps-2026" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Best Sump Pumps 2026</h4></Link>
            <Link href="/articles/battery-vs-water-powered-sump-pumps" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Battery vs Water-Powered Backup</h4></Link>
            <Link href="/articles/backup-power-sump-pumps" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Backup Power for Sump Pumps</h4></Link>
            <Link href="/articles/smart-sump-pumps-guide" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Smart Sump Pumps</h4></Link>
            <Link href="/articles/types-of-foundation-cracks" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Types of Foundation Cracks</h4></Link>
            <Link href="/articles/foundation-crack-repair-cost" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Foundation Crack Repair Cost</h4></Link>
            <Link href="/articles/bowing-basement-walls" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Bowing Basement Walls</h4></Link>
            <Link href="/articles/wet-basement-walls" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Wet Basement Walls</h4></Link>
            <Link href="/articles/water-coming-up-through-basement-floor" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Water Coming Up Through Floor</h4></Link>
            <Link href="/articles/how-to-prevent-basement-mold" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">How to Prevent Basement Mold</h4></Link>
            <Link href="/articles/mold-remediation-cost" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Mold Remediation Cost</h4></Link>
            <Link href="/articles/musty-basement-smell" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Musty Basement Smell</h4></Link>
            <Link href="/articles/basement-efflorescence" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Basement Efflorescence</h4></Link>
            <Link href="/articles/basement-humidity-guide" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Basement Humidity Guide</h4></Link>
            <Link href="/articles/best-basement-dehumidifiers" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Best Basement Dehumidifiers</h4></Link>
            <Link href="/articles/dehumidifier-myths" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Dehumidifier Myths</h4></Link>
            <Link href="/articles/waterproof-basement-paint-sealers" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Waterproof Paint and Sealers</h4></Link>
            <Link href="/articles/drylok-vs-radonseal" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">DRYLOK vs RadonSeal</h4></Link>
            <Link href="/articles/best-vapor-barriers" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Best Vapor Barriers</h4></Link>
            <Link href="/articles/crystalline-waterproofing" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Crystalline Waterproofing</h4></Link>
            <Link href="/articles/how-to-finish-a-basement" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">How to Finish a Basement</h4></Link>
            <Link href="/articles/pre-finish-audit" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Pre-Finish Audit Checklist</h4></Link>
            <Link href="/articles/basement-finishing-cost" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Basement Finishing Cost</h4></Link>
            <Link href="/articles/how-to-hire-a-waterproofing-contractor" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">How to Hire a Waterproofing Contractor</h4></Link>
            <Link href="/articles/waterproofing-home-appraisal-value" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Waterproofing and Home Value</h4></Link>
            <Link href="/articles/basement-flooding-insurance" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Basement Flooding Insurance</h4></Link>
            <Link href="/articles/basement-waterproofing-finances-insurance-taxes" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Waterproofing Finances</h4></Link>
            <Link href="/articles/radon-and-basement-waterproofing" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Radon and Waterproofing</h4></Link>
            <Link href="/articles/basement-radon-testing-mitigation-guide" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Radon Testing and Mitigation</h4></Link>
            <Link href="/articles/homebuyers-basement-inspection-checklist" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Homebuyers Inspection Checklist</h4></Link>
            <Link href="/articles/spring-basement-checklist" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">Spring Basement Checklist</h4></Link>
            <Link href="/articles/how-to-dry-out-basement-after-flooding" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">How to Dry Out After Flooding</h4></Link>
            <Link href="/articles/diy-vs-hiring-pro-basement-projects" className="block p-4 border border-gray-200 rounded-lg hover:border-teal-500 transition-colors"><h4 className="font-semibold text-gray-900">DIY vs Hiring a Pro</h4></Link>
          </div>
        </section>

        {/* Network Links */}
        <section className="mb-16 bg-gray-50 p-6 rounded-lg">
          <h3 className="text-xl font-semibold text-gray-900 mb-4">Our Network</h3>
          <p className="text-gray-700 mb-3"><a href="https://thegarage.guide/articles/water-leaking-into-garage" className="text-teal-700 underline hover:text-teal-900">The Garage Guide</a> covers water leaking into garage, which shares the same causes (poor grading, gutter problems, hydrostatic pressure) as basement water intrusion. Many of the drainage principles in this guide apply to garage-level water problems as well.</p>
          <p className="text-gray-700"><a href="https://theseptic.guide/articles/septic-overflow-after-rain" className="text-teal-700 underline hover:text-teal-900">The Septic Guide</a> covers septic overflow after rain, which can compound basement water problems in homes where both the septic system and the basement are stressed by the same heavy rain events.</p>
        </section>
