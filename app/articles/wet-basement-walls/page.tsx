  ...
  return (
    <div>
      ...
      <div className='mx-auto max-w-3xl px-4 py-10'>
        <p className='text-lg text-gray-700 leading-relaxed'>Wet basement walls are not all the same problem. Water streaming through a crack during a rainstorm is a different issue than a wall that feels damp to the touch year-round, and both are different from white, crusty deposits appearing on the surface. Each has a different cause, a different fix, and a different price tag.</p>
