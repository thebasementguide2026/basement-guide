    ...
    <div className='bg-white min-h-screen'>
      ...
      <article className='max-w-4xl mx-auto px-6 py-16'>
        <div className='prose prose-lg prose-slate max-w-none'>
          ...
          <p className='text-lg text-slate-700 leading-relaxed mb-8'>
            Water on your basement floor doesn&rsquo;t always come from the walls. Sometimes it bubbles up from below, seeping through cracks in the slab, pooling along the edges where the floor meets the wall, or appearing as a damp patch with no obvious source.
          </p>
          <p className='text-lg text-slate-700 leading-relaxed mb-8'>
            This is a different problem than a leaky foundation wall, and it requires a different set of solutions. The first priority is figuring out whether it&rsquo;s a plumbing emergency or a groundwater issue. That distinction determines everything: who you call, how urgent it is, and what the fix costs.
          </p>
        </div>
      </article>
