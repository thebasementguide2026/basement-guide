...
export const metadata: Metadata = {
  ...
  description: 'Complete guide to choosing the right sump pump. HP, pedestal vs submersible, and backup systems explained.',
};
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-24'>
          <div className='lg:col-span-8 space-y-16'>
            ...
            <section className='space-y-8'>
              ...
              <p className='text-lg text-slate-600 leading-relaxed'>There are two primary types of sump pumps:</p>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                <div className='bg-slate-50 p-8 rounded-3xl border border-slate-100'>
                  <h3 className='text-2xl font-bold mb-4'>Submersible</h3>
                  <p className='text-slate-600'>The motor sits inside the sump pit underwater. Quieter and more powerful.</p>
                </div>
                <div className='bg-slate-50 p-8 rounded-3xl border border-slate-100'>
                  <h3 className='text-2xl font-bold mb-4'>Pedestal</h3>
                  <p className='text-slate-600'>The motor mounts above the water line. Easier to service but louder.</p>
                </div>
              </div>
            </section>
            ...
            <section className='space-y-8'>
              ...
              <p className='text-lg text-slate-600 leading-relaxed'>Most residential pumps range from 1/3 HP to 1 HP.</p>
              <ul className='space-y-4 text-slate-600'>
                <li><strong>1/3 HP:</strong> Standard for most homes with average water levels.</li>
                <li><strong>1/2 HP:</strong> Ideal for high-water areas or deep pits.</li>
                <li><strong>3/4 - 1 HP:</strong> For extreme conditions or commercial use.</li>
              </ul>
            </section>

            <section className='space-y-8'>
              <h2 className='text-4xl font-black text-slate-900 tracking-tight'>3. Backup Systems</h2>
              <p className='text-lg text-slate-600 leading-relaxed'>
                A primary pump is only useful when there is power. A battery-backup or water-powered backup system is essential for storm protection.
              </p>
            </section>
          </div>
          ...
          <div className='lg:col-span-4'>
            <div className='sticky top-12 bg-indigo-600 rounded-[3rem] p-12 text-white'>
              ...
              <p className='text-indigo-100 mb-8'>Not sure which pump to choose? Connect with local pros for a free quote.</p>
