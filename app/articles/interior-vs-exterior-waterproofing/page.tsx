          ...
          <div className='space-y-6 my-8 not-prose'>
            <div className='bg-slate-50 rounded-2xl p-6 border border-slate-200'>
              ...
              <ul className='space-y-2 text-slate-600 text-sm'>
                <li className='flex items-start gap-2'><span className='text-teal-500'>&#10003;</span> <strong>Interior French drain (perimeter drain):</strong> Perforated pipe installed along the interior perimeter beneath the basement floor collects water and directs it to a sump pump. This is the standard professional solution for most wet basements. See our French drain cost guide and our interior basement drainage systems guide for a detailed comparison of system types.</li>
                <li className='flex items-start gap-2'><span className='text-teal-500'>&#10003;</span> <strong>Sump pump and basin:</strong> Removes collected water from the drainage system and ejects it outside the home. Battery backup is essential for power outage protection during storms. See our battery vs water-powered backup comparison and backup power for sump pumps guide.</li>
                <li className='flex items-start gap-2'><span className='text-teal-500'>&#10003;</span> <strong>Crack injection:</strong> Epoxy or polyurethane fills active leaks in poured concrete walls. Epoxy restores structural strength for stable cracks. Polyurethane creates a flexible seal for cracks that may still move slightly. See our foundation crack repair cost guide.</li>
                <li className='flex items-start gap-2'><span className='text-teal-500'>&#10003;</span> <strong>Wall coatings and sealers:</strong> Crystalline or silicate products penetrate concrete to reduce moisture passage. Waterproof paints like DRYLOK or RadonSeal provide surface-level moisture resistance. See our waterproof basement paint and sealers guide and DRYLOK vs RadonSeal comparison.</li>
                <li className='flex items-start gap-2'><span className='text-teal-500'>&#10003;</span> <strong>Vapor barriers and dimple mats:</strong> Heavy-duty polyethylene sheeting or dimple mat membranes installed on basement walls create an air gap and drainage plane that captures wall moisture and directs it into the drainage system. Essential before finishing a basement with drywall. See our best vapor barriers guide.</li>
              </ul>
            </div>
