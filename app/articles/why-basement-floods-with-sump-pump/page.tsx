      ...
      <section className=\"relative h-[70vh] min-h-[500px] bg-slate-900 overflow-hidden\">
        ...
        <div className=\"relative h-full max-w-7xl mx-auto px-6 flex flex-col justify-end pb-24\">
          ...
          <p className=\"text-xl md:text-2xl text-slate-300 max-w-2xl font-light leading-relaxed\">
            Having a sump pump doesn't guarantee a dry basement. Here are the most common reasons it's still failing you.
          </p>
          ...
          <div className=\"lg:col-span-8 space-y-16\">
            ...
            <section className=\"space-y-8\">
              ...
              <p className=\"text-lg text-slate-600 leading-relaxed\">
                One of the most common issues is a pump that simply cannot keep up with the volume of water entering your basement. If you live in an area with heavy rainfall or have a high water table, a standard 1/3 HP pump may not be enough. Upgrading to a 1/2 HP or higher pump can make a significant difference.
              </p>
            </section>
            ...
            <section className=\"space-y-8\">
              ...
              <p className=\"text-lg text-slate-600 leading-relaxed\">
                Most basement flooding happens during storms — and storms cause power outages. Your primary sump pump is useless without electricity. A battery backup pump or water-powered backup system is not optional if you want true protection.
              </p>
            </section>
            ...
            <section className=\"space-y-8\">
              ...
              <p className=\"text-lg text-slate-600 leading-relaxed\">
                Your pump could be running perfectly, but if the discharge line is clogged with debris or frozen solid in winter, the water has nowhere to go. Inspect your discharge line regularly, especially after cold snaps.
              </p>
            </section>
            ...
            <section className=\"space-y-8\">
              ...
              <p className=\"text-lg text-slate-600 leading-relaxed\">
                If the float switch that triggers your pump is set too high, by the time the pump kicks on, water has already entered your living space. The float switch should be adjusted so the pump activates before water reaches the basement floor level.
              </p>
            </section>

            <section className=\"space-y-8\">
              <h2 className=\"text-4xl font-black text-slate-900 tracking-tight\">5. Water is Entering Through Walls, Not the Floor</h2>
              <p className=\"text-lg text-slate-600 leading-relaxed\">
                A sump pump only removes water that has already entered through the floor and collected in the pit. If water is seeping in through cracks in your foundation walls, the pump will never catch it. This is a waterproofing issue, not a pump issue.
              </p>
              <div className=\"bg-red-50 border border-red-100 rounded-3xl p-8\">
                <p className=\"text-slate-700 font-semibold\">If water is entering through your walls, you may need interior or exterior waterproofing, not just a better pump.</p>
              </div>
            </section>
            ...
            <section className=\"space-y-8\">
              ...
              <p className=\"text-lg text-slate-600 leading-relaxed\">
                Most sump pumps last 7 to 10 years. If yours is older, it may be running but not pumping effectively. An annual test — pouring a bucket of water into the pit to trigger the float — is the easiest way to check.
              </p>
            </section>
          ...
          <div className=\"lg:col-span-4\">
            <div className=\"sticky top-12 bg-indigo-600 rounded-[3rem] p-12 text-white\">
              ...
              <p className=\"text-indigo-100 mb-8\">
                Not sure what's causing your flooding? Connect with a local waterproofing expert for a free diagnosis.
              </p>
