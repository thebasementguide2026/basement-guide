      ...
      <article className='max-w-4xl mx-auto px-4 py-12 md:py-16'>
        ...
        <section className='mb-16'>
          ...
          <div className='grid md:grid-cols-2 gap-6 mb-10'>
            ...
            <div className='bg-white rounded-lg p-6 shadow-sm border border-slate-200'><Link href='/articles/basement-mice-pest-prevention' className='text-emerald-700 underline hover:text-emerald-900 font-semibold'>Basement Mice & Pest Prevention</Link><p className='text-slate-600 text-sm mt-1'>The other consequence of unsealed foundation and utility penetrations. The same air-sealing work that reduces moisture entry also closes the rodent entry paths that lead to nesting in wall cavities.</p></div>
          </div>
