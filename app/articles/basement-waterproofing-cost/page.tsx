      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        <div className='max-w-4xl'>
          ...
          <ul className='space-y-3 text-slate-700 mb-6'>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Minor dampness or condensation:</strong> Start with waterproof paint or sealer ($300&ndash;$4,000) and a <Link href='/articles/dehumidifier-myths' className='text-teal-600 underline hover:text-teal-800'>dehumidifier</Link>. This isn&rsquo;t true waterproofing &mdash; it&rsquo;s moisture management &mdash; but for mild issues, it may be all you need.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>One or two leaking cracks:</strong> <Link href='/articles/foundation-crack-repair-cost' className='text-teal-600 underline hover:text-teal-800'>Crack injection</Link> ($250&ndash;$800 per crack) is targeted, affordable, and effective. Epoxy for structural cracks, polyurethane for active leaks.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Widespread seepage or recurring water:</strong> Interior French drain + sump pump. The standard solution and where most homeowners land.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Severe, persistent flooding:</strong> Full exterior waterproofing, possibly combined with an interior drainage system.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Combination approach:</strong> Many experienced contractors recommend addressing the exterior drainage first (gutters, grading, downspout extensions &mdash; often free or cheap fixes) before spending thousands on interior systems. Sometimes fixing the surface water problem solves 90% of the issue.</li>
          </ul>
          <p className='text-slate-700 leading-relaxed mb-12'>
          ...
          <ul className='space-y-2 text-slate-700 mb-6'>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span>Applying <Link href='/articles/waterproof-basement-paint-sealers' className='text-teal-600 underline hover:text-teal-800'>waterproof paint or sealer</Link> to walls &mdash; $200&ndash;$500 in materials</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span>Sealing small cracks with hydraulic cement or polyurethane caulk &mdash; $20&ndash;$50 per crack</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span>Improving exterior grading so water flows away from the foundation &mdash; often free</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span>Extending downspouts at least 6 feet from the house &mdash; $10&ndash;$30 per downspout</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span>Adding or cleaning gutters &mdash; varies</li>
          </ul>
          <h3 className='text-xl font-bold text-slate-900 mb-4'>Not realistic DIY projects:</h3>
          <ul className='space-y-2 text-slate-700 mb-6'>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Interior French drain installation</strong> &mdash; requires cutting concrete, managing drainage slope, proper sump pit construction, and electrical work. One mistake with the slope means water pools instead of draining.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Exterior waterproofing</strong> &mdash; requires professional excavation equipment, membrane application expertise, and proper backfill techniques. Getting this wrong can compromise your foundation.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Sump pump installation</strong> &mdash; technically possible for a handy homeowner, but electrical work near water is a safety concern, and improper discharge routing causes neighborhood drainage problems.</li>
          </ul>
          <p className='text-slate-700 leading-relaxed mb-12'>
          ...
          <ul className='space-y-3 text-slate-700 mb-6'>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Get 3&ndash;5 written quotes.</strong> Not ballpark numbers over the phone &mdash; actual written estimates after they&rsquo;ve seen your basement. Quotes should specify the method, materials, linear footage, pump model, and warranty terms.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Ask what they&rsquo;re actually installing.</strong> You want to know pipe diameter, gravel type, sump pump model and horsepower, and whether a battery backup is included.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Check for licensing, insurance, and warranty.</strong> Verify their license. Make sure they carry liability insurance and workers&rsquo; comp. A transferable warranty matters for resale value.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Be skeptical of the lowest bid.</strong> If one quote comes in at $2,000 and the others are $5,000&ndash;$7,000, the low bidder is probably cutting corners.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Be skeptical of high-pressure sales.</strong> Some companies use scare tactics to pressure you into signing on the spot. A legitimate contractor will give you time to think.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Ask for references and check reviews.</strong> Google reviews, BBB, and Angi are good starting points. Ask for 2&ndash;3 recent customers you can call.</li>
          </ul>
          <p className='text-slate-700 leading-relaxed mb-12'>
          ...
          <ul className='space-y-2 text-slate-700 mb-6'>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Contractor financing:</strong> Payment plans through third-party lenders. Read the terms carefully &mdash; promotional rates expire.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Home equity loan or HELOC:</strong> Lower interest rates, but your home is collateral.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Personal loan:</strong> Quick approval, no home equity required, but higher rates (8&ndash;15%).</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Credit card:</strong> Only for smaller jobs (crack injection, paint) where you can pay it off quickly.</li>
          </ul>
          <p className='text-slate-700 leading-relaxed mb-12'>
          ...
          <ul className='space-y-3 text-slate-700 mb-6'>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>1.</span><strong>Fix the exterior first (often free).</strong> Clean your gutters, extend downspouts at least 6 feet from the house, and check the grading around your foundation. The ground should slope away at roughly 1 inch per foot for the first 6 feet. The U.S. Department of Housing and Urban Development identifies poor exterior drainage as the most common cause of basement moisture.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>2.</span><strong>Run a <Link href='/articles/dehumidifier-myths' className='text-teal-600 underline hover:text-teal-800'>dehumidifier</Link>.</strong> If the dampness is condensation rather than actual water intrusion, a quality dehumidifier ($200&ndash;$600) may be all you need. Keep basement <Link href='/articles/basement-humidity-guide' className='text-teal-600 underline hover:text-teal-800'>humidity below 50%</Link>.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>3.</span><strong>Seal visible cracks.</strong> <Link href='/articles/foundation-crack-repair-cost' className='text-teal-600 underline hover:text-teal-800'>Crack injection</Link> at $250&ndash;$800 per crack handles isolated leak points.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>4.</span><strong>Apply waterproof sealer.</strong> If walls are damp but not actively leaking, a <Link href='/articles/waterproof-basement-paint-sealers' className='text-teal-600 underline hover:text-teal-800'>waterproof sealer</Link> buys you time. Budget $300&ndash;$800 DIY or $1,500&ndash;$4,000 professional.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>5.</span><strong>Full drainage system.</strong> If the above steps don&rsquo;t solve it, then invest in an interior French drain and sump pump. At this point, you know you&rsquo;ve eliminated the easy fixes.</li>
          </ul>
          ...
          <ul className='space-y-3 text-slate-700 mb-6'>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Start outside.</strong> Before spending a dollar on interior waterproofing, fix your gutters, extend your downspouts, and correct your grading. These are cheap or free and solve the problem for more homeowners than you&rsquo;d expect.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Don&rsquo;t put it off.</strong> Water damage is progressive. A $5,000 fix today prevents a $15,000 fix in three years. Every year you wait, the problem gets more expensive.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Get multiple quotes.</strong> Three to five written estimates from licensed, insured contractors. Compare specifics, not just bottom-line numbers.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Invest in the pump.</strong> If you&rsquo;re getting an interior system, don&rsquo;t let the contractor install the cheapest pump available. A quality submersible pump with a battery backup is the heart of the system &mdash; and the part that saves your basement during a power outage in a storm.</li>
            <li className='flex items-start'><span className='text-indigo-500 mr-3 mt-1 font-bold'>&bull;</span><strong>Waterproof before you finish.</strong> If you&rsquo;re planning to <Link href='/articles/how-to-finish-a-basement' className='text-teal-600 underline hover:text-teal-800'>finish your basement</Link>, waterproof first. Always. No exceptions.</li>
          </ul>
          <p className='text-slate-700 leading-relaxed mb-6'>
