      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        <div className='max-w-4xl'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-8'>
            <div className='bg-indigo-50 border border-indigo-200 rounded-2xl p-8'>
              ...
              <ul className='space-y-4 text-slate-700'>
                ...
                <li className='mb-2'><span className='text-green-600 mr-2'>&#10003;</span>Installs in 1 &ndash; 5 days</li>
            ...
            <div className='bg-purple-50 border border-purple-200 rounded-2xl p-8'>
              ...
              <ul className='space-y-4 text-slate-700'>
                ...
                <li className='mb-2'><span className='text-green-600 mr-2'>&#10003;</span>Costs 2&ndash;3x more, takes 1&ndash;2 weeks</li>
          ...
          <ul className='list-disc pl-6 space-y-4 text-slate-700 mb-6'>
            <li className='mb-3'>Applying <Link href='/articles/waterproof-basement-paint-sealers' className='text-teal-600 underline hover:text-teal-800'>waterproof paint or sealer</Link> to walls &mdash; $200&ndash;$500 in materials</li>
            <li className='mb-3'>Sealing small cracks with hydraulic cement or polyurethane caulk &mdash; $20&ndash;$50 per crack</li>
            <li className='mb-3'>Improving exterior grading so water flows away from the foundation &mdash; often free</li>
            <li className='mb-3'>Extending downspouts at least 6 feet from the house &mdash; $10&ndash;$30 per downspout</li>
          ...
          <ul className='list-disc pl-6 space-y-3 text-slate-700 mb-6'>
            <li className='mb-3'><strong>Get 3&ndash;5 written quotes.</strong> Not ballpark numbers over the phone &mdash; actual written estimates after they&rsquo;ve seen your basement. Quotes should specify the method, materials, linear footage, pump model, and warranty terms.</li>
            ...
            <li className='mb-3'><strong>Be skeptical of the lowest bid.</strong> If one quote comes in at $2,000 and the others are $5,000&ndash;$7,000, the low bidder is probably cutting corners.</li>
            ...
            <li className='mb-3'><strong>Ask for references and check reviews.</strong> Google reviews, BBB, and Angi are good starting points. Ask for 2&ndash;3 recent customers you can call.</li>
          </ul>
          <p className='text-slate-700 leading-relaxed mb-12'>
          ...
          <ul className='list-disc pl-6 space-y-4 text-slate-700 mb-6'>
            ...
            <li className='mb-3'><strong>Personal loan:</strong> Quick approval, no home equity required, but higher rates (8&ndash;15%).</li>
          ...
          <ul className='list-disc pl-6 space-y-3 text-slate-700 mb-6'>
            ...
            <li className='mb-3'><span className='text-indigo-600 font-bold mr-2'>3.</span><strong>Seal visible cracks.</strong> <Link href='/articles/foundation-crack-repair-cost' className='text-teal-600 underline hover:text-teal-800'>Crack injection</Link> at $250&ndash;$800 per crack handles isolated leak points.</li>
